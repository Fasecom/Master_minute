...
class ShopYearRevenueChart extends Component
{
    public Workshop $shop;
    ...
    public function mount(Workshop $shop): void
    {
        $this->shop = $shop;
    ...
    public function onMonthYearUpdated(string $monthYear): void
    {
        ...
        // dispatch event to update chart in browser
    ...
    private function generateData(): void
    {
        ...
        for ($i = 11; $i >= 0; $i--) {
            ...
            $sum = WorkingShift::query()
                ->where('workshop_id', $this->shop->id)
    ...
    {
        return view('livewire.charts.shop-year-revenue-chart');
    }
} 